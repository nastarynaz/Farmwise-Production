// Simplified CropAnalysis class - Only shows plain response text
import 'dart:io';
...
class CropAnalysis extends StatefulWidget {
  ...
  @override
  State<CropAnalysis> createState() => _CropAnalysisState();
}

class _CropAnalysisState extends State<CropAnalysis> {
  ...
  Future<void> _performAnalysis() async {
    try {
      ...
      final resp = await scanAI(base64Image, ScanType.info);
      ...
      setState(() {
        if (resp.statusCode == 200 && resp.response != null) {
          ...
          _errorMessage = resp.err ?? "Failed to analyze plants";
          _isLoading = false;
        }
      });
    } catch (e) {
